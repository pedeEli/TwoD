...
#define TD_INTERNAL_YAML_STRUCT_DECODE_NO_DEFAULT(preprocess, type, vname) preprocess( \
	if (!node[#vname]) { \
		TD_CORE_ERROR("missing field {} in {}", #vname, typeid(decltype(rhs)).name()); \
		return false; \
	} \
...
#define TD_INTERNAL_YAML_ENUM_BIT_OPERATOR(enum_name, op) \
...
#define TD_INTERNAL_YAML_ENUM_BOOL_OPERATOR(enum_name, op) \
	constexpr bool operator op(enum_name a, enum_name b) noexcept { \
		return static_cast<std::underlying_type_t<enum_name>>(a) op static_cast<std::underlying_type_t<enum_name>>(b); \
	}
#define TD_INTERNAL_YAML_ENUM_BIT_UNARY_OPERATOR(enum_name, op) \
	constexpr enum_name operator op(enum_name a) noexcept { \
		return static_cast<enum_name>(op static_cast<std::underlying_type_t<enum_name>>(a)); \
	}

#define TD_INTERNAL_YAML_ENUM_YAML_ENCODE(ns_name, enum_name, ...) \
...
#define TD_INTERNAL_YAML_ENUM_YAML_DECODE(ns_name, enum_name, ...) \
...
#define TD_INTERNAL_YAML_ENUM_YAML(ns_name, enum_name, ...) \
	namespace YAML { \
		template<> \
...
#define TD_INTERNAL_YAML_ENUM_DEF(enum_name, enum_name_with_base, ...) \
...
#define TD_INTERNAL_YAML_ENUM_FUN_DEF(ns_name, enum_name, ...) \
	TD_INTERNAL_YAML_ENUM_YAML(ns_name, enum_name, __VA_ARGS__) \
	TD_INTERNAL_YAML_ENUM_IMGUI(ns_name, enum_name, __VA_ARGS__)

#define TD_INTERNAL_YAML_ENUM(enum_name, enum_name_with_base, ...) \
	TD_INTERNAL_YAML_ENUM_DEF(enum_name, enum_name_with_base, __VA_ARGS__) \
	TD_INTERNAL_YAML_ENUM_FUN_DEF(, enum_name, __VA_ARGS__)
#define TD_INTERNAL_YAML_ENUM_WITH_NS(ns_name, enum_name, enum_name_with_base, ...) \
	namespace ns_name { \
		TD_INTERNAL_YAML_ENUM_DEF(enum_name, enum_name_with_base, __VA_ARGS__) \
	} \
	TD_INTERNAL_YAML_ENUM_FUN_DEF(::ns_name::, enum_name, __VA_ARGS__)


#define TD_YAML_ENUM(enum_name, ...) TD_INTERNAL_YAML_ENUM(enum_name, enum_name, __VA_ARGS__)
#define TD_YAML_ENUM_WITH_BASE(enum_name, base, ...) TD_INTERNAL_YAML_ENUM(enum_name, enum_name : base, __VA_ARGS__)
#define TD_YAML_ENUM_WITH_NS(ns_name, enum_name, ...) TD_INTERNAL_YAML_ENUM_WITH_NS(ns_name, enum_name, enum_name, __VA_ARGS__)
#define TD_YAML_ENUM_WITH_NS_AND_BASE(ns_name, enum_name, base, ...) TD_INTERNAL_YAML_ENUM_WITH_NS(ns_name, enum_name, enum_name : base, __VA_ARGS__)
